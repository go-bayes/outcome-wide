...
df <- readh("outcomewide-forgiveness-no-miss-model")
...
embody_plots <-
  ...
  selfcontrol_p +
  sleep_p +
  sexualsat_p + plot_annotation(title = "Causal effects of X on embodied wellbeing", #subtitle = "xyz",
                                tag_levels = "A") +
...
ggsave(
  embody_plots,
   path = here::here(here::here("figs", "figs_forgiveness", "no-impute")),
  width = 15,
  height = 12,
  units = "in",
...
health_plots <- alcoholfreq_p +
  ...
  sfhealth_p +
  smoker_p +
  plot_annotation(title = "Causal effects of X on health outcomes",
                  # subtitle = "xyz",
...
reflective_plots <- gratitude_p +
  ...
  selfesteem_p +
  veng_p +
  plot_annotation(title = "Causal effects of X on reflective wellbeing") +
...
social_plots <- belong_p +
  community_p +
  nwi_p +
  support_p + plot_annotation(title = "Causal effects of X on social wellbeing") +
  plot_layout(guides = 'collect') #+ plot_layout(nrow = 3, byrow = T)
...
econ_plots <-# income_p +
  ...
  worklife_p +
  volunteers_p +
  plot_annotation(title = "Causal effects of X on economic wellbeing") +
...
pwi_plots <-
  ...
  yourhealth_p+
  standardliving_p+
  futuresecurity_p+plot_annotation(title = "Causal effects of X on PWI subcales", #subtitle = "xyz",
                                   tag_levels = "A") +
  plot_layout(guides = 'collect') #+ plot_layout(nrow = 3, byrow = T)
