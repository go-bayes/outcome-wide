...
xlab = "Your.Health_lead1_z"  ## Monthly Church
...
ylim = c(-.25, .25)  # SET AS YOU LIKE -- here, how much movement across a standard deviation unit of the outcome
ylim_contrast = c(.5,.5)# SET AS YOU LIKE (FOR CONTRASTS )
...
god_c <- vanderweelevalue_rr_lo(out_ct, f)
god_c
...
# Create risk ratio table
spirit_c <- vanderweelevalue_rr_lo(out_ct, f)
spirit_c
