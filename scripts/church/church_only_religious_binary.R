...
xlab = "ChurchTri_lead1"  ## Monthly Church
...
summary(pool(out_m))
#
# evalues.OLS(-0.04205497580, se = 0.010855166, sd = 1, delta = 4, true = 0)
# alcoholfreq_c
...
# coef + estimate
evalues.OLS(-0.02356646012, se = 0.015134306, sd = 1, delta = 4, true = 0)
