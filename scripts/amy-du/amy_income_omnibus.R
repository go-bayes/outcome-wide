...
df_a$Male <- factor(df_a$Male, labels = c("No", "Yes"))
df_a$Euro <- factor(df_a$Euro, labels = c("No", "Yes"))
df_a$Retired <- factor(df_a$retired, labels = c("No", "Yes"))
