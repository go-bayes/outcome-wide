...
df <- readRDS(here::here( "/Users/joseph/v-project\ Dropbox/Joseph\ Bulbulia/outcomewide/pets", "outcomewide-pets-ml_zero_base"))
ml <- readRDS(here::here( "/Users/joseph/v-project\ Dropbox/Joseph\ Bulbulia/outcomewide/pets", "outcomewide-pets-mf_zero_base"))
...
gcomp_forestplot_pets_gain <- gcomp_forestplot(out_pets, title = "Outcomewide Perfectionism", ylim = c(-.2,.2), xlab = "Incidence Perfectionism (SD)")
gcomp_forestplot_pets_gain
